faqs = {
    "faqs": [
        {
            "title": "¿Si presento problemas con la aplicación qué debería hacer?",
            "body": "Primero le aconsejamos que lea esta sección de la aplicación, "
            "y si su interrogante sigue sin ser respondida, le invitamos a que "
        ...
        {
            "title": "¿Por qué si recién terminó el parte del Minsap no se han "
            "actualizado "
            "los datos? ¿Cuándo se hará?",
            "body": "Todos nuestros datos son tomados a partir de los partes del "
            "Minsap por lo que, tras terminar la conferencia nuestro equipo de "
        ...
        {
            "title": "La fecha de los datos que aparece en la aplicación tiene "
            "un día de atraso. ¿Significa esto qué no se han actualizado los datos?",
            "body": "No, los partes que se realizan diariamente por el Minsap "
            "contienen los casos registrados hasta las 11:59 pm de la noche anterior. "
            "Por lo que la información que se considera actualizada con "
            "respecto al parte tiene un día de atraso.",
        },
        {
            "title": "¿Es posible emplear la aplicación de conjunto con la bolsa "
            "nauta?",
            "body": "No, desgraciadamente no está dentro de las posibilidades de "
            "nuestro equipo de que sea accedible la aplicación por la bolsa nauta. "
            "Por lo que necesita estar conectado ya sea por wifi o por datos "
            "para poder consultar nuestra información.",
        },
        {
            "title": "¿La aplicación consume datos nacionales?",
            "body": "Si, aunque es posible seleccionar de cual fuente de datos "
            "prefiere obtener su información. Si prefiere que consuma primero de "
        ...
        {
            "title": "¿Es posible emplear los datos de los que dispone la aplicación?",
            "body": "Si, es posible emplear los datos que disponemos. Los tenemos "
        ...
        {
            "title": "¿Es posible acceder a la vista del Pesquisador Virtual o la de la"
            "Tabla de Casos sin conexión?",
            "body": "No, no es posible acceder la vista del Pesquisador Virtual ni a "
        ...
        {
            "title": "¿Es posible acceder a la vista del Pesquisador Virtual desde "
            "fuera de Cuba?",
            "body": "No, esta funcionalidad es exclusiva para Cuba. No es posible "
            "acceder desde fuera del territorio nacional cubano. Si se encuentra en "
