tips = {'tips': [
    ...
    },
    {
        ...
        'info': 'Los coronavirus son una extensa familia de virus que pueden causar '
    ...
    },
    {
        ...
        'info': 'La COVID-19 es la enfermedad infecciosa causada por el coronavirus '
    ...
    {
        'header': '¿Es posible contagiarse de COVID-19 por contacto con una persona que '
                  'no presente ningún síntoma?',
        'info': 'La principal forma de propagación de la enfermedad es a través de '
    ...
    },
    {
        ...
        'info': 'Por lo general, los síntomas de la COVID-19 son leves, sobre todo '
    ...
    },
    {
        ...
        'info': 'Se han notificado casos en una pequeña cantidad de animales en el mundo infectados por el virus '
                'que causa la COVID-19, en su mayoría después de haber tenido contacto con una persona con COVID-19.'
                ' Con base a la información limitada disponible hasta la fecha, '
                'el riesgo de que los animales transmitan '
                'la COVID-19 a las personas se considera bajo. Al parecer el virus que causa la COVID-19 puede'
                ' propagarse de personas a animales en ciertas situaciones por lo que debe tratar a las mascotas '
                'como a otros familiares humanos, no deje que interactúen con personas o animales fuera del hogar.'
                ' No permita que las mascotas interactúen con otras personas ni animales fuera del hogar. Mantenga'
                ' a sus gatos dentro de la casa siempre que sea posible, para evitar que interactúen con otros '
                'animales o personas. Pasee a sus perros con correa, manteniendo una distancia de al menos 6 pies '
                '(2 metros) de otras personas y animales. Evite los parques para perros o los espacios públicos '
                'donde se reúnen grandes cantidades de personas y perros. Lávese las manos luego de estar con '
                'animales y manipular su comida, desechos o suministros. Practique buenos hábitos de higiene '
                'con su mascota y limpie sus desechos adecuadamente. Esta es una situación que cambia rápidamente'
                ' y la información se actualizará a medida que esté disponible.'
    },
    {
        'header': '¿Cuánto tiempo sobrevive el virus en una superficie?',
        'info': 'No se sabe con certeza cuánto tiempo sobrevive el virus causante de '
    ...
    {
        'header': '¿El virus que provoca la COVID-19 puede transmitirse en zonas con climas cálidos y '
                  'húmedos?',
        'info': 'Las pruebas científicas obtenidas hasta ahora indican que el virus '
    ...
    {
        'header': '¿El nuevo coronavirus NO PUEDE transmitirse a través de picaduras de '
                  'mosquitos?',
    ...
    {
        'header': 'El nuevo coronavirus, ¿Afecta solo a las personas de edad o también '
