    ...
    'changelog': [
        ...
        },
        {
            ...
            'added': [
                ...
                'Comparación de los casos activos, los diarios, los recuperados, los fallecidos y el Oxford Stringency Index de distintos países con Cuba.',
                'Casos recuperados y fallecidos a la table de Top 20 de Países con más casos acumulados.',
                'Pantalla de estadísticas por municipios, accesible desde el menú lateral.',
                'Posibilidad de acceder a las estadíticas por provincias y municipios sin conexión para ver la última información que se descargó.',
                ...
                'Consejos y Respuestas sobre la Covid-19, accesible desde el menú lateral.',
                'Pantalla con información del equipo de desarrollo, de colaboradores, de autores, etc. accesible desde el menú lateral.',
            ],
            'fixed': [
