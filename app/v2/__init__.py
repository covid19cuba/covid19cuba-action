...
from ..static.tips import tips as advices
...
def build_changelog(debug):
    dump_util('api/v2', lambda _: data_changelog, debug=debug)


def build_about_us(debug):
    dump_util('api/v2', lambda _: data_about_us, debug=debug)


def build_tips(debug):
    dump_util('api/v2', lambda _: advices, debug= debug)
