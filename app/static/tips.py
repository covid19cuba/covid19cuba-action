tips = {
    "tips": [
        {
            "header": "Puede reducir el riesgo de infección:",
            "info": "- Lavándose las manos regularmente con agua y jabón o con "
        ...
        {
            "header": "Los signos y síntomas pueden ser:",
            "info": "- Dolor de garganta\n\n"
            "- Tos\n\n"
            "- Fiebre\n\n"
            "- Dificultad para respirar (en casos graves)",
        },
        {
            "header": "La COVID-19 se caracteriza por:",
            "info": "Síntomas leves, como, dolor de garganta, tos y fiebre. La "
        ...
        {
            "header": "El nuevo coronavirus se propaga principalmente por:",
            "info": "Contacto directo (1 metro o 3 pies) con una persona infectada "
            "cuando tose o estornuda, o por contacto con sus gotículas "
            "respiratorias (saliva o secreciones nasales).",
        },
        {
            "header": "Cómo ponerse, usar, quitarse y desechar una mascarilla:",
            "info": "- Antes de ponerse una mascarilla, lávese las manos con un "
        ...
        {
            "header": "¿Qué es un coronavirus?",
            "info": "Los coronavirus son una extensa familia de virus que pueden "
            "causar enfermedades tanto en animales como en humanos. En los humanos, "
        ...
        {
            "header": "¿Qué es la COVID-19?",
            "info": "La COVID-19 es la enfermedad infecciosa causada por el "
        ...
        {
            "header": "¿Es posible contagiarse de COVID-19 por contacto con una "
            "persona que no presente ningún síntoma?",
            "info": "La principal forma de propagación de la enfermedad es a través "
            "de las gotículas respiratorias expelidas por alguien al toser. Muchas "
        ...
        {
            "header": "Evite tocarse los ojos, la nariz y la boca. ¿Por qué?",
            "info": "Las manos tocan muchas superficies y pueden recoger "
        ...
        {
            "header": "¿Debo preocuparme por la COVID-19?",
            "info": "Por lo general, los síntomas de la COVID-19 son leves, "
            "sobre todo en los niños y los adultos jóvenes. No obstante, "
            "también pueden ser graves y obligan a hospitalizar a alrededor "
            "de uno de cada cinco infectados. Por consiguiente, es bastante "
            "normal preocuparse por los efectos que el brote de COVID-19 puede "
            "tener en nosotros y en nuestros seres queridos.",
        },
        {
            "header": "¿Cuánto dura el periodo de incubación de la COVID-19?",
            "info": "El «período de incubación» es el tiempo que transcurre entre la "
        ...
        {
            "header": "¿Mi mascota me puede contagiar la COVID-19?",
            "info": "Se han notificado casos en una pequeña cantidad de animales "
            "en el mundo infectados por el virus que causa la COVID-19, en su "
            "mayoría después de haber tenido contacto con una persona con COVID-19."
            " Con base a la información limitada disponible hasta la fecha, "
            "el riesgo de que los animales transmitan la COVID-19 a las personas "
            "se considera bajo. Al parecer el virus que causa la COVID-19 puede"
            " propagarse de personas a animales en ciertas situaciones por lo que "
            "debe tratar a las mascotas como a otros familiares humanos, no deje "
            "que interactúen con personas o animales fuera del hogar."
            " No permita que las mascotas interactúen con otras personas ni animales "
            "fuera del hogar. Mantenga a sus gatos dentro de la casa siempre que "
            "sea posible, para evitar que interactúen con otros "
            "animales o personas. Pasee a sus perros con correa, manteniendo una "
            "distancia de al menos 6 pies (2 metros) de otras personas y animales. "
            "Evite los parques para perros o los espacios públicos "
            "donde se reúnen grandes cantidades de personas y perros. Lávese las "
            "manos luego de estar con animales y manipular su comida, desechos o "
            "suministros. Practique buenos hábitos de higiene "
            "con su mascota y limpie sus desechos adecuadamente. Esta es una situación "
            "que cambia rápidamente y la información se actualizará a medida que "
            "esté disponible.",
        },
        {
            "header": "¿Cuánto tiempo sobrevive el virus en una superficie?",
            "info": "No se sabe con certeza cuánto tiempo sobrevive el virus causante "
            "de la COVID-19 en una superficie, pero parece comportarse como otros "
        ...
        {
            "header": "¿El virus que provoca la COVID-19 puede transmitirse en zonas "
            "con climas cálidos y húmedos?",
            "info": "Las pruebas científicas obtenidas hasta ahora indican que el "
            "virus de la COVID-19 puede transmitirse en CUALQUIER ZONA, incluidas las "
        ...
        {
            "header": "¿El nuevo coronavirus NO PUEDE transmitirse a través de "
            "picaduras de mosquitos?",
            "info": "El nuevo coronavirus es un virus respiratorio que se propaga "
        ...
        {
            "header": "El nuevo coronavirus, ¿Afecta solo a las personas de edad "
            "o también puede afectar a las más jóvenes?",
            "info": "El nuevo coronavirus (2019-nCoV) puede infectar a personas de "
