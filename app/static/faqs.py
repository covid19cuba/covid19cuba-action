    ...
    'faqs': [
        {
            ...
            'body': 'Primero le aconsejamos que lea esta sección de la aplicación, y si '
        ...
        {
            'title': '¿Por qué si recién terminó el parte del Minsap no se han actualizado '
            'los datos? ¿Cuándo se hará?',

            'body': 'Todos nuestros datos son tomados a partir de los partes del Minsap '
        ...
        {
            'title': 'La fecha de los datos que aparece en la aplicación tiene un día de '
            'atraso. ¿Significa esto qué no se han actualizado los datos?',

            'body': 'No, los partes que se realizan diariamente por el Minsap contienen '
        ...
        {
            'title': '¿Es posible emplear la aplicación de conjunto con la bolsa nauta?',

            'body': 'No, desgraciadamente no está dentro de las posibilidades de nuestro '
        ...
        },
        {
            ...
            'body': 'Si, aunque es posible seleccionar de cual fuente de datos prefiere '
        ...
        {
            'title': '¿Es posible acceder a la vista del Pesquisador Virtual desde fuera '
            'de Cuba?',

            'body': 'No, esta funcionalidad es exclusiva para Cuba. No es posible acceder '
